...
class TestEnginesAreSatisfiable:
    ...
    def test_browser_ui_node_floor_is_not_stricter_than_its_toolchain(self):
        """The browser UI must not demand more Node than its build tools do.
        ...
        assert _satisfies_range("22.22.0", node_range), (
            ...
            "22.12 — stricter than Vite requires. A browser UI floor above the "
