...
# Node stages stream build logs to %TEMP% via Tee-Object, so aliased profile
# paths can abort setup even when the underlying command succeeded.
...
# certificate chain" / UNABLE_TO_GET_ISSUER_CERT_LOCALLY during package downloads. The reporter
