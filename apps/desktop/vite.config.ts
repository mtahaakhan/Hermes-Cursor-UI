...
// runtime. Its default is a CDN; keep the UI self-contained by serving the
// bundled emojibase-data package at a stable local path — middleware
...
export default defineConfig(({ command }) => ({
  ...
  build: {
    ...
    //     of tiny files and slow cold loads.
