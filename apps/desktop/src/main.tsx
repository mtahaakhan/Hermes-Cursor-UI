...
// Side-effect: reports in-flight turns to the browser host capability layer.
import './store/active-work'
// Side-effect: mirrors power state when the host can provide it.
import './store/power'
// Side-effect: applies persisted surface appearance preferences on load.
...
// Browser-first Cursor workspace skin. Kept behind a root class so the
// structural restyle is isolated and easy to revert.
document.documentElement.classList.add('cursor-ui')
