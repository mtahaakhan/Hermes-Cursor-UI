      ...
      <ComposerPrimitive.Unstable_TriggerPopoverRoot>
        ...
        >
          ...
          <ComposerPrimitive.Root
            className={cn(
              'group/composer relative w-full overflow-visible rounded-[10px]',
...
export function ChatBarFallback() {
  return (
    <div
      className={cn(
        'group/composer absolute bottom-0 left-1/2 z-30 w-[min(var(--composer-width),calc(100%-2rem))] max-w-full -translate-x-1/2 rounded-[10px] pt-2 pb-[var(--composer-shell-pad-block-end)]',
