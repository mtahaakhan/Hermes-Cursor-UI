...
function ChatHeader({
  ...
  return (
    <header
      className={cn(titlebarHeaderBaseClass, 'cursor-editor-header', isRoutedSessionView && titlebarHeaderShadowClass)}
    >
      <div
        className={cn(titlebarHeaderTitleClass, 'cursor-editor-tabs', showProfileTag && 'flex items-center')}
        style={{
          maxWidth:
            'calc(100vw - var(--titlebar-content-inset,0px) - var(--titlebar-tools-right) - var(--titlebar-tools-width) - 1.5rem)'
        }}
      >
        <div className="cursor-editor-tab">
